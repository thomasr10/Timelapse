...
import { CircleUserRound, UsersRound, Menu } from 'lucide-react';
        ...
        <header className="header section-container">
            ...
            <div className="burger-container">
                ...
                <nav className={`burger-menu ${isOpen ? 'open' : ''}`}>
                    ...
                    {/* <div className="separator"></div> */}
                    <Link className="burger-connected-link" to={`/${user?.username}`}>
            ...
            <div className="header-connected-link">
                ...
                {/* <Bell /> */}
                <Link to={`/${user?.username}`} className="profile-icon"><CircleUserRound /></Link>
            </div>
        </header>
    )
}